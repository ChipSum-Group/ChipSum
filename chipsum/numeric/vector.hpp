...
namespace ChipSum
{
    namespace Numeric
    {
        ...
        public:
             ...
             * @return {*}
             */
            CHIPSUM_DECLARED_FUNCTION Vector(const vector_type &data, const_size_type size) : __size(size)
            {
                ChipSum::Numeric::Impl::Vector::Create<ScalarType, SizeType>(__size, __data);
           ...
           template<typename RetType>
            ...
            CHIPSUM_FUNCTION_INLINE Vector operator*(ScalarType s)
            {
                ...
                ChipSum::Numeric::Impl::Vector::Scal<ScalarType, SizeType>(ret.GetData(), s, GetData());
             ...
             * @return {*}
             */
            CHIPSUM_FUNCTION_INLINE Vector operator*(Scalar<ScalarType, SizeType, BackendType> s)
            {
            ...
            CHIPSUM_FUNCTION_INLINE Vector &operator*=(ScalarType s)
            {
                ChipSum::Numeric::Impl::Vector::Scal<ScalarType, SizeType>(__data, s, GetData());
                return *this;
            }
