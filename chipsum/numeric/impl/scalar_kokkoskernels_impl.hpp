 ...
 * @LastEditTime: 2021-08-09 15:08:51
...
struct Scalar_Traits<ScalarType,SizeType,ChipSum::Backend::KokkosKernels,Props...>:
        public Operator_Traits<ScalarType,SizeType,ChipSum::Backend::KokkosKernels,Props...>
{
    using scalar_type = Kokkos::View<ScalarType>;
    
    using device_scalar_value_type = typename Kokkos::View<ScalarType>::HostMirror;
