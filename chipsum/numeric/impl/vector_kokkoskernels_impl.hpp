 ...
 * @LastEditTime: 2021-08-10 15:03:17
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: ChipSum/chipsum/numeric/impl/vector_kokkoskernels_impl.hpp
 */
    ...
    namespace Numeric
    {
        ...
        namespace Impl
        {
             ...
             */
                ...
                {
                    assert(X.extent(0) > 0);
                    R = Kokkos::View<ScalarType *>("vector_" + std::to_string(vector_name++), X.extent(0));
                    Kokkos::parallel_for(R.extent(0), Scal_Functor<ScalarType, SizeType>(a, X, R));
                }
